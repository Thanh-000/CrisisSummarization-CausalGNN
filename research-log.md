...
| 16 | 2026-03-22 | refactor | **Full 3-phase V4 refactor:** (1) Integrated GCA, ThreeModalityClassifier, GenericTrainer, V4Config into src/; (2) Archived V3 dead code to models_v3.py/losses_v3.py (~507 LOC); (3) Notebook now imports from src/ (-27% LOC, 1169→855 lines). Package bumped to v4.0.0. |
