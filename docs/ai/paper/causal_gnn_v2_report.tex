...
\KwOut{Mô hình $f(\theta)$ vững chắc và $\text{MemoryBank}$}
 ...
 \For{$epoch \leftarrow 1$ \KwTo $15$}{
  \For{minibatch $(v, t, y) \in \mathcal{D}$}{
   $z_{unified} \leftarrow \text{Concat}(\text{ModalityProj}(v, t))$\;
