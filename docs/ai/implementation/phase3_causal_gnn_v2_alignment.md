...
### 📊 Báo Cáo Kết Quả Cuối Cùng (Task 1 & Task 3)
*Kết quả dưới đây thu được sau khi chạy Multi-seed experiment (Seeds: 42, 2024, 2025)*

| Task | Metric | Mean ± Std |
| :--- | :--- | :--- |
| **Task 1 (Informative)** | Weighted F1 | `0.8274` (Best Seed) |
| | Balanced Accuracy | `0.8257` (Best Seed) |
| **Task 3 (Damage)** | Weighted F1 | `0.6931 ± 0.0027` |
